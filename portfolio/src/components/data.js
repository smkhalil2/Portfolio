export const projectData = [
  ...
  },
  {
    id: 1,
    title: "LilyHoney",
    description: {context: 'LilyHoney is an eCommerce site UI designed in Figma as part of a Udemy online course. The fictional client was generated randomly, the name is a combination of my cat\'s name and a random product. The product is a high quality organic honey marketed towards adults age 18-35.', contribution:'I began the design process by randomly generating a user persona for my target demographic and establishing a task flow. Using the tesk flow, I generated an interactive wireframe outlining the process for purchasing products from the app. Then I constructed a moodboard and color palette to help define a tone for the brand. Using the wireframe as a basis, I designed a high fidelity mobile mockup using AI generated images to simulate product shots. I am currently designing desktop and tablet versions of the interface. I also designed a logo for the product that expresses a rustic, homemade quality and evokes the use of natural ingredients.', lesson:'The project allowed me to learn and use Figma tools and techniques. I learned how to use basic Figma structures like frames, shapes, and text components. I also learned how to convert these into reusable assets, define variables, use effects, and implement animations. I practiced making the mockups interactive in Prototype mode. I learned to apply UI/UX design principles to address accessibility, responsiveness, and branding, applying features like Auto-Layout and Constraints to build a visually appealing and consistent UI.'},
  ...
  },
  {
    ...
    description:{context:'Color Palette Maker is an art tool built with React.js and Material UI. You can explore pre-made color palettes for inspiration, or you can build and save your own. Clicking on a color copies it to your clipboard. You can choose to copy it as an hex, rgb, or rgba value. Using a slider, you can increase or decrease the saturation of colors in a palette. Selecting \'More\' on a color display different shades of that color.', contribution:'I programmed this project using JavaScript, HTML, and CSS. I used Material UI components with custom styles. I utilized built-in React hooks and also defined custom hooks. I defined reusable components that are configured differently to perform multiple functions across the app. The UI is responsive; Text color changes to remain readable on depending on the lightness of a color and the palettes change shape to fit on a smaller window size.', lesson:'This project allowed me to exercise skills learned as part of a Udemy online React bootcamp. As the course was created for class based React, I made an effort to redesign it to use functional React. This allowed me to use hooks to handle state changes. I also personalized the UI design to look more modern and engaging.'},
    category: "React App",
  ...
  },
  {
    id: 6,
    title: "This Website!",
    description:{context:'I designed this site with Figma and built it using React.js with Next.js and TailwindCSS. I chose to use TailwindCSS because it allowed me to construct a prototype quickly and apply changes easily. I was able to construct a first deployment in a week and implemented a total redesign in about two days. I am using Next.js to take advantage of server-side rendering to decrease load times, and because Next.js makes it easier to implement page routing.', contribution:'I began by designing a wireframe in Figma that was essentially a breakdown of my resume. Originally, I was inspired by the color palette of \"Spider-Man: Across the Spider-Verse\" and incorporated the purple and green associated with Spider-Gwen\'s universe into the design. I converted my wireframe into a low fidelity mockup for a single page site. Using this mockup as a basis, I constructed an initial deploymen. I sent this prototype out to friends and family for review. Feedback was positive overall, with some complaints that the animated skill badges were misleading as they were not clickable and that some of the text was hard to read over the hero section background colors.\n\nPersonally, I was not satisfied with the site either. I felt the initial design lacked a sense of modernity, fun, or style. I wanted the site to showcase my creativity and subtly hint at my nerdiness, but I was afraid of going overboard and risking making UI appear amateurish. While researching site inspiration, I discovered candycode.com. Please excuse this shameless plug, but their sites unique UI blew me away. Their use of color with pop and counter culture imagery imbued their site with a sense of magic and rebellious creativity that encouraged me to think outside the box. \n\nMy subsequent redesign of the site embraces my personal creative style and nerdiness. The white 60\'s sci-fi dots are inspired by the interior of the classic TARDIS from BBC\'s \"Doctor Who\." They to create a sense of vast, open space. I drew the sketches on these project cards in Autodesk Sketchbook Pro in my personal style, expressing my creativity, imagination, and attention to detail.', lesson:'Building this site has been a valuable experience both practically and creatively. As my first real project outside of academia and online courses, I set out to define my own criteria for success. I was able to apply what I have learned in React.js and Figma, but I also had to teach myself new tools like TailwindCSS. I took inspiration from candycode.com to think about what makes me unique as an artist and use my skills to express my personality with UI design. \n\nThank you for exploring my site!'},
    category: "React App",
